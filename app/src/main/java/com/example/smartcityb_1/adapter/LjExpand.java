...
/**
 * @Login Name win10
 * @Create by 张瀛煜 on 2020/10/8 at 17:13
 */
public class LjExpand extends BaseExpandableListAdapter {
    private Map<String, List<String>> map;
    private String[] arr = {"木头", "玻璃"};

    public LjExpand(Map<String, List<String>> map) {
        this.map = map;
    }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        itemName.setText(arr[groupPosition]);
        return convertView;
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        TextView itemName = convertView.findViewById(R.id.item_name);
        itemName.setText(map.get(arr[groupPosition]).get(childPosition));
        return convertView;
    }
