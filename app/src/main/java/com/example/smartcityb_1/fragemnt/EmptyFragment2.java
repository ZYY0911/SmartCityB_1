...
public class EmptyFragment2 extends Fragment {
    ...
    public EmptyFragment2() {
    }

    private AppHomeActivity appHomeActivity;

    public EmptyFragment2(AppHomeActivity appHomeActivity) {
        this.appHomeActivity = appHomeActivity;
    }

    public static EmptyFragment2 newInstance(AppHomeActivity appHomeActivity) {
        return new EmptyFragment2(appHomeActivity);
    }
