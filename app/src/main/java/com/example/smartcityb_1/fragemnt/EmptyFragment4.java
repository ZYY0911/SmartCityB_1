 ...
 */
public class EmptyFragment4 extends Fragment {
    private ImageView itemChange;
    private TextView title;
    private TextView title1;

    public EmptyFragment4() {
    }

    private AppHomeActivity appHomeActivity;

    public EmptyFragment4(AppHomeActivity appHomeActivity) {
        this.appHomeActivity = appHomeActivity;
    }

    public static EmptyFragment4 newInstance(AppHomeActivity appHomeActivity) {
        return new EmptyFragment4(appHomeActivity);
    }
