...
public class EmptyFragment extends Fragment {
    ...
    public EmptyFragment(AppHomeActivity appHomeActivity) {
        this.appHomeActivity = appHomeActivity;
    }

    public static EmptyFragment newInstance(AppHomeActivity appHomeActivity) {
        return new EmptyFragment(appHomeActivity);
    }
